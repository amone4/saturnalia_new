...
<!-- 
	<section class="cd-section">
		<div class="bck" id="home">
			...
			<div class="middle">
				<img src="img/brand.png" class="img-head"><br>
				<h1 class="aliter-branding">SATURNALIA 17</h1>
			</div>
		</div>
	</section> -->
	...
	<section class="cd-section visible">
		<div>
			<div class="row">
				<div class="col-md-4 fullscreen">Division 1</div>
				<div class="col-md-4 fullscreen">Division 2</div>
				<div class="col-md-4 fullscreen">Division 3</div>
			</div>
		</div>
	</section>
